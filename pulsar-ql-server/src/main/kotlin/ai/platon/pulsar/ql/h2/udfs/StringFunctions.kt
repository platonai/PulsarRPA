...
object StringFunctions {
    ...
    @UDFunction @JvmStatic fun isAlpha(str: CharSequence?): Boolean = StringUtils.isAlpha(str)
    @UDFunction @JvmStatic fun isNumeric(str: CharSequence?): Boolean = StringUtils.isNumeric(str)
...
//    @UDFunction @JvmStatic fun remove(str: String?, arg1: Char): String? = StringUtils.remove(str, arg1)
    @UDFunction @JvmStatic fun equals(str: CharSequence?, arg1: CharSequence): Boolean = StringUtils.equals(str, arg1)
    @UDFunction @JvmStatic fun length(str: CharSequence?): Int = StringUtils.length(str)
...
//    @UDFunction @JvmStatic fun indexOf(str: CharSequence?, arg1: Int): Int = StringUtils.indexOf(str, arg1)
//    @UDFunction @JvmStatic fun indexOf(str: CharSequence?, arg1: Int, arg2: Int): Int = StringUtils.indexOf(str, arg1, arg2)
    @UDFunction @JvmStatic fun indexOf(str: CharSequence?, arg1: CharSequence): Int = StringUtils.indexOf(str, arg1)
    @UDFunction @JvmStatic fun indexOf(str: CharSequence?, arg1: CharSequence, arg2: Int): Int = StringUtils.indexOf(str, arg1, arg2)
    @UDFunction @JvmStatic fun isWhitespace(str: CharSequence?): Boolean = StringUtils.isWhitespace(str)
    @UDFunction @JvmStatic fun isEmpty(str: CharSequence?): Boolean = StringUtils.isEmpty(str)
    @UDFunction @JvmStatic fun equalsIgnoreCase(str: CharSequence?, arg1: CharSequence): Boolean = StringUtils.equalsIgnoreCase(str, arg1)
    @UDFunction @JvmStatic fun startsWith(str: CharSequence?, arg1: CharSequence): Boolean = StringUtils.startsWith(str, arg1)
    @UDFunction @JvmStatic fun endsWith(str: CharSequence?, arg1: CharSequence): Boolean = StringUtils.endsWith(str, arg1)
//    @UDFunction @JvmStatic fun lastIndexOf(str: CharSequence?, arg1: Int): Int = StringUtils.lastIndexOf(str, arg1)
    @UDFunction @JvmStatic fun lastIndexOf(str: CharSequence?, arg1: CharSequence): Int = StringUtils.lastIndexOf(str, arg1)
//    @UDFunction @JvmStatic fun lastIndexOf(str: CharSequence?, arg1: Int, arg2: Int): Int = StringUtils.lastIndexOf(str, arg1, arg2)
    @UDFunction @JvmStatic fun lastIndexOf(str: CharSequence?, arg1: CharSequence, arg2: Int): Int = StringUtils.lastIndexOf(str, arg1, arg2)
    @UDFunction @JvmStatic fun substring(str: String?, arg1: Int): String? = StringUtils.substring(str, arg1)
    @UDFunction @JvmStatic fun substring(str: String?, arg1: Int, arg2: Int): String? = StringUtils.substring(str, arg1, arg2)
    ...
    @UDFunction @JvmStatic fun contains(str: CharSequence?, arg1: CharSequence): Boolean = StringUtils.contains(str, arg1)
    @UDFunction @JvmStatic fun contains22(str: CharSequence?, arg1: Int): Boolean = StringUtils.contains(str, arg1)
...
//    @UDFunction @JvmStatic fun join(str: ShortArray, arg1: Char, arg2: Int, arg3: Int): String? = StringUtils.join(str, arg1, arg2, arg3)
    ...
    @UDFunction @JvmStatic fun isBlank(str: CharSequence?): Boolean = StringUtils.isBlank(str)
...
//    @UDFunction @JvmStatic fun repeat(str: Char, arg1: Int): String? = StringUtils.repeat(str, arg1)
    ...
    @UDFunction @JvmStatic fun isNotBlank(str: CharSequence?): Boolean = StringUtils.isNotBlank(str)
    ...
    @UDFunction @JvmStatic fun isNotEmpty(str: CharSequence?): Boolean = StringUtils.isNotEmpty(str)
    @UDFunction @JvmStatic fun ordinalIndexOf(str: CharSequence?, arg1: CharSequence, arg2: Int): Int = StringUtils.ordinalIndexOf(str, arg1, arg2)
    @UDFunction @JvmStatic fun indexOfIgnoreCase(str: CharSequence?, arg1: CharSequence): Int = StringUtils.indexOfIgnoreCase(str, arg1)
    @UDFunction @JvmStatic fun indexOfIgnoreCase(str: CharSequence?, arg1: CharSequence, arg2: Int): Int = StringUtils.indexOfIgnoreCase(str, arg1, arg2)
    @UDFunction @JvmStatic fun lastOrdinalIndexOf(str: CharSequence?, arg1: CharSequence, arg2: Int): Int = StringUtils.lastOrdinalIndexOf(str, arg1, arg2)
    @UDFunction @JvmStatic fun lastIndexOfIgnoreCase(str: CharSequence?, arg1: CharSequence): Int = StringUtils.lastIndexOfIgnoreCase(str, arg1)
    @UDFunction @JvmStatic fun lastIndexOfIgnoreCase(str: CharSequence?, arg1: CharSequence, arg2: Int): Int = StringUtils.lastIndexOfIgnoreCase(str, arg1, arg2)
    @UDFunction @JvmStatic fun containsIgnoreCase(str: CharSequence?, arg1: CharSequence): Boolean = StringUtils.containsIgnoreCase(str, arg1)
    @UDFunction @JvmStatic fun containsWhitespace(str: CharSequence?): Boolean = StringUtils.containsWhitespace(str)
    @UDFunction @JvmStatic fun indexOfAny(str: CharSequence?, arg1: String): Int = StringUtils.indexOfAny(str, arg1)
    @UDFunction @JvmStatic fun containsAny(str: CharSequence?, arg1: CharSequence): Boolean = StringUtils.containsAny(str, arg1)
    @UDFunction @JvmStatic fun indexOfAnyBut(str: CharSequence?, arg1: CharSequence): Int = StringUtils.indexOfAnyBut(str, arg1)
    @UDFunction @JvmStatic fun containsOnly(str: CharSequence?, arg1: String): Boolean = StringUtils.containsOnly(str, arg1)
    @UDFunction @JvmStatic fun containsNone(str: CharSequence?, arg1: String): Boolean = StringUtils.containsNone(str, arg1)
    ...
    @UDFunction @JvmStatic fun countMatches(str: CharSequence?, arg1: CharSequence): Int = StringUtils.countMatches(str, arg1)
    @UDFunction @JvmStatic fun isAlphaSpace(str: CharSequence?): Boolean = StringUtils.isAlphaSpace(str)
    @UDFunction @JvmStatic fun isAlphanumeric(str: CharSequence?): Boolean = StringUtils.isAlphanumeric(str)
    @UDFunction @JvmStatic fun isAlphanumericSpace(str: CharSequence?): Boolean = StringUtils.isAlphanumericSpace(str)
    @UDFunction @JvmStatic fun isAsciiPrintable(str: CharSequence?): Boolean = StringUtils.isAsciiPrintable(str)
    @UDFunction @JvmStatic fun isNumericSpace(str: CharSequence?): Boolean = StringUtils.isNumericSpace(str)
    @UDFunction @JvmStatic fun isAllLowerCase(str: CharSequence?): Boolean = StringUtils.isAllLowerCase(str)
    @UDFunction @JvmStatic fun isAllUpperCase(str: CharSequence?): Boolean = StringUtils.isAllUpperCase(str)
    ...
    @UDFunction @JvmStatic fun defaultIfBlank(str: CharSequence?, arg1: CharSequence): CharSequence? = StringUtils.defaultIfBlank(str, arg1)
    @UDFunction @JvmStatic fun defaultIfEmpty(str: CharSequence?, arg1: CharSequence): CharSequence? = StringUtils.defaultIfEmpty(str, arg1)
    ...
    @UDFunction @JvmStatic fun indexOfDifference(str: CharSequence?, arg1: CharSequence): Int = StringUtils.indexOfDifference(str, arg1)
    @UDFunction @JvmStatic fun getCommonPrefix(str: Array<String>): String? = StringUtils.getCommonPrefix(*str)
    @UDFunction @JvmStatic fun getLevenshteinDistance(str: CharSequence?, arg1: CharSequence): Int = StringUtils.getLevenshteinDistance(str, arg1)
    @UDFunction @JvmStatic fun getLevenshteinDistance(str: CharSequence?, arg1: CharSequence, arg2: Int): Int = StringUtils.getLevenshteinDistance(str, arg1, arg2)
    @UDFunction @JvmStatic fun getJaroWinklerDistance(str: CharSequence?, arg1: CharSequence): Double = StringUtils.getJaroWinklerDistance(str, arg1)
    @UDFunction @JvmStatic fun startsWithIgnoreCase(str: CharSequence?, arg1: CharSequence): Boolean = StringUtils.startsWithIgnoreCase(str, arg1)
    @UDFunction @JvmStatic fun startsWithAny(str: CharSequence?, arg1: Array<String>): Boolean = StringUtils.startsWithAny(str, *arg1)
    @UDFunction @JvmStatic fun endsWithIgnoreCase(str: CharSequence?, arg1: CharSequence): Boolean = StringUtils.endsWithIgnoreCase(str, arg1)
    @UDFunction @JvmStatic fun normalizeSpace(str: String?): String? = StringUtils.normalizeSpace(str)
    @UDFunction @JvmStatic fun endsWithAny(str: CharSequence?, arg1: Array<String>): Boolean = StringUtils.endsWithAny(str, *arg1)
    @UDFunction @JvmStatic fun appendIfMissing(str: String?, arg1: CharSequence, arg2: Array<String>): String? = StringUtils.appendIfMissing(str, arg1, *arg2)
    @UDFunction @JvmStatic fun appendIfMissingIgnoreCase(str: String?, arg1: CharSequence, arg2: Array<String>): String? = StringUtils.appendIfMissingIgnoreCase(str, arg1, *arg2)
    @UDFunction @JvmStatic fun prependIfMissing(str: String?, arg1: CharSequence, arg2: Array<String>): String? = StringUtils.prependIfMissing(str, arg1, *arg2)
    @UDFunction @JvmStatic fun prependIfMissingIgnoreCase(str: String?, arg1: CharSequence, arg2: Array<String>): String? = StringUtils.prependIfMissingIgnoreCase(str, arg1, *arg2)
