...
abstract class TestBase {
    ...
    companion object {
        ...
        fun afterClass() {
            ...
            val path = ScentPaths.get(PULSAR_ROOT, "history", "sql-history-$ident.sql")
            Files.createDirectories(path.parent)
            ScentFiles.saveTo(sqls, path, deleteIfExists = true)
        }
    }
...
//            SysProperties.serializeJavaObject = true
            ...
            val numTests = this::class.members.count {
                it.annotations.any { it is Test } && it.annotations.none { it is Ignore }
            }
            if (numTests > 0) {
