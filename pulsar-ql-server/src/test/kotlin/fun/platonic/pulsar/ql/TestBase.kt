...
import `fun`.platonic.pulsar.common.config.PulsarConstants.PULSAR_ROOT
...
abstract class TestBase {
    ...
    fun afterTest() {
        ...
        val path = ScentPaths.get(PULSAR_ROOT, "history", ident, "sql-history.sql")
        Files.createDirectories(path.parent)
        Files.write(path, sqls.toByteArray(), StandardOpenOption.CREATE, StandardOpenOption.WRITE, StandardOpenOption.APPEND)
    }
}
