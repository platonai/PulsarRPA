...
import `fun`.platonic.scent.dom.Documents
import `fun`.platonic.scent.dom.HEIGHT
import `fun`.platonic.scent.dom.WIDTH
import `fun`.platonic.scent.dom.nodes.DescriptiveDocument
import `fun`.platonic.scent.dom.nodes.DocumentSettings.Companion.SELECTOR_IN_BOX_DEVIATION
import `fun`.platonic.scent.dom.nodes.getFeature
import `fun`.platonic.scent.dom.nodes.select2
import `fun`.platonic.scent.dom.nodes.uniqueName
...
class TestExtendedCss {
    ...
    private val doc: DescriptiveDocument = Documents.parse(stream, "UTF-8", baseUri)
