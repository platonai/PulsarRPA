...
class TestSelector {
    ...
    fun caseInsensitive() {
        ...
        assertEquals(1, doc.select("DiV[TiTLE]").size.toLong())
        assertEquals(1, doc.select("DiV[TiTLE=BAR]").size.toLong())
        assertEquals(0, doc.select("DiV[TiTLE=BARBARELLA]").size.toLong())
    }
    ...
    fun containsOwn() {
        ...
        assertEquals(1, doc2.select("p:containsOwn(igor)").size.toLong())
