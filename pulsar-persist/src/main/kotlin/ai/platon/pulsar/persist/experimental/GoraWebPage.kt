...
//    }
    ...
    companion object {
        ...
        fun newWebPage(url: String, mutableConfig: ai.platon.pulsar.common.config.MutableConfig): GoraWebPage {
            Objects.requireNonNull(url)
            Objects.requireNonNull(mutableConfig)
            return newWebPageInternal(url, mutableConfig)
        }

        private fun newWebPageInternal(url: String, mutableConfig: ai.platon.pulsar.common.config.MutableConfig?): GoraWebPage {
            Objects.requireNonNull(url)
