...
public class ProtocolHeaders implements HttpHeaders {
    ...
    public String get(String name) {
        CharSequence value = headers.get(AbstractWebPage.u8(name));
    ...
    public void put(String name, String value) {
        headers.put(AbstractWebPage.u8(name), AbstractWebPage.u8(value));
    }
    ...
    public void remove(String name) {
        headers.remove(AbstractWebPage.u8(name));
    }
