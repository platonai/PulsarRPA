 ...
 */
final public class MutableWebPage implements Comparable<WebPage>, WebPage, GWebPageAware {

    private static final AtomicInteger SEQUENCER = new AtomicInteger();

    public static final MutableWebPage NIL = newInternalPage(NIL_PAGE_URL, 0, "nil", "nil");
