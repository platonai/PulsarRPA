...
public class GParseStatus extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"GParseStatus\",\"namespace\":\"fun.platonic.pulsar.persist.gora.generated\",\"fields\":[{\"name\":\"majorCode\",\"type\":\"int\",\"default\":0},{\"name\":\"minorCode\",\"type\":\"int\",\"default\":0},{\"name\":\"args\",\"type\":{\"type\":\"map\",\"values\":[\"null\",\"string\"]},\"default\":{}}]}");
  private static final long serialVersionUID = 3052154248130919007L;
  ...
  public static fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder newBuilder() {
      return new fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder();
  }
  
  /** Creates a new GParseStatus RecordBuilder by copying an existing Builder */
  public static fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder newBuilder(fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder other) {
      return new fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder(other);
  }
  
  /** Creates a new GParseStatus RecordBuilder by copying an existing GParseStatus instance */
  public static fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder newBuilder(fun.platonic.pulsar.persist.gora.generated.GParseStatus other) {
      return new fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GParseStatus>
    ...
    private Builder() {
        super(fun.platonic.pulsar.persist.gora.generated.GParseStatus.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing GParseStatus instance */
    private Builder(fun.platonic.pulsar.persist.gora.generated.GParseStatus other) {
        super(fun.platonic.pulsar.persist.gora.generated.GParseStatus.SCHEMA$);
    ...
    /** Sets the value of the 'majorCode' field */
    public fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder setMajorCode(int value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder clearMajorCode() {
    ...
    /** Sets the value of the 'minorCode' field */
    public fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder setMinorCode(int value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder clearMinorCode() {
    ...
    /** Sets the value of the 'args' field */
    public fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder setArgs(java.util.Map<java.lang.CharSequence, java.lang.CharSequence> value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GParseStatus.Builder clearArgs() {
      args = null;
