...
public class GFieldGroup extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"GFieldGroup\",\"namespace\":\"fun.platonic.pulsar.persist.gora.generated\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"default\":0},{\"name\":\"parentId\",\"type\":\"long\",\"default\":0},{\"name\":\"name\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"fields\",\"type\":{\"type\":\"map\",\"values\":[\"null\",\"string\"]},\"default\":{}}]}");
  private static final long serialVersionUID = 2177205719231613216L;
  ...
  public static fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder newBuilder() {
      return new fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder();
  }
  
  /** Creates a new GFieldGroup RecordBuilder by copying an existing Builder */
  public static fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder newBuilder(fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder other) {
      return new fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder(other);
  }
  
  /** Creates a new GFieldGroup RecordBuilder by copying an existing GFieldGroup instance */
  public static fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder newBuilder(fun.platonic.pulsar.persist.gora.generated.GFieldGroup other) {
      return new fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GFieldGroup>
    ...
    private Builder() {
        super(fun.platonic.pulsar.persist.gora.generated.GFieldGroup.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing GFieldGroup instance */
    private Builder(fun.platonic.pulsar.persist.gora.generated.GFieldGroup other) {
        super(fun.platonic.pulsar.persist.gora.generated.GFieldGroup.SCHEMA$);
    ...
    /** Sets the value of the 'id' field */
    public fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder setId(long value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder clearId() {
    ...
    /** Sets the value of the 'parentId' field */
    public fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder setParentId(long value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder clearParentId() {
    ...
    /** Sets the value of the 'name' field */
    public fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder setName(java.lang.CharSequence value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'fields' field */
    public fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder setFields(java.util.Map<java.lang.CharSequence, java.lang.CharSequence> value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GFieldGroup.Builder clearFields() {
      fields = null;
