...
public class GProtocolStatus extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"GProtocolStatus\",\"namespace\":\"fun.platonic.pulsar.persist.gora.generated\",\"fields\":[{\"name\":\"majorCode\",\"type\":\"int\",\"default\":0},{\"name\":\"minorCode\",\"type\":\"int\",\"default\":0},{\"name\":\"args\",\"type\":{\"type\":\"map\",\"values\":[\"null\",\"string\"]},\"default\":{}}]}");
  ...
  public static fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder newBuilder() {
      return new fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder();
  }
  
  /** Creates a new GProtocolStatus RecordBuilder by copying an existing Builder */
  public static fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder newBuilder(fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder other) {
      return new fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder(other);
  }
  
  /** Creates a new GProtocolStatus RecordBuilder by copying an existing GProtocolStatus instance */
  public static fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder newBuilder(fun.platonic.pulsar.persist.gora.generated.GProtocolStatus other) {
      return new fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GProtocolStatus>
    ...
    private Builder() {
        super(fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing GProtocolStatus instance */
    private Builder(fun.platonic.pulsar.persist.gora.generated.GProtocolStatus other) {
        super(fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.SCHEMA$);
    ...
    /** Sets the value of the 'majorCode' field */
    public fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder setMajorCode(int value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder clearMajorCode() {
    ...
    /** Sets the value of the 'minorCode' field */
    public fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder setMinorCode(int value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder clearMinorCode() {
    ...
    /** Sets the value of the 'args' field */
    public fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder setArgs(java.util.Map<java.lang.CharSequence, java.lang.CharSequence> value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GProtocolStatus.Builder clearArgs() {
      args = null;
