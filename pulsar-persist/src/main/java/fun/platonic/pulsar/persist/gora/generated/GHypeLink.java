...
public class GHypeLink extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"GHypeLink\",\"namespace\":\"fun.platonic.pulsar.persist.gora.generated\",\"fields\":[{\"name\":\"url\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"anchor\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"order\",\"type\":\"int\",\"default\":0}]}");
  private static final long serialVersionUID = -4623584566929812570L;
  ...
  public static fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder newBuilder() {
      return new fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder();
  }
  
  /** Creates a new GHypeLink RecordBuilder by copying an existing Builder */
  public static fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder newBuilder(fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder other) {
      return new fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder(other);
  }
  
  /** Creates a new GHypeLink RecordBuilder by copying an existing GHypeLink instance */
  public static fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder newBuilder(fun.platonic.pulsar.persist.gora.generated.GHypeLink other) {
      return new fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GHypeLink>
    ...
    private Builder() {
        super(fun.platonic.pulsar.persist.gora.generated.GHypeLink.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing GHypeLink instance */
    private Builder(fun.platonic.pulsar.persist.gora.generated.GHypeLink other) {
        super(fun.platonic.pulsar.persist.gora.generated.GHypeLink.SCHEMA$);
    ...
    /** Sets the value of the 'url' field */
    public fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder setUrl(java.lang.CharSequence value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder clearUrl() {
      url = null;
    ...
    /** Sets the value of the 'anchor' field */
    public fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder setAnchor(java.lang.CharSequence value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder clearAnchor() {
      anchor = null;
    ...
    /** Sets the value of the 'order' field */
    public fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder setOrder(int value) {
    ...
    public fun.platonic.pulsar.persist.gora.generated.GHypeLink.Builder clearOrder() {
