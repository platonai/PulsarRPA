 ...
 */
package fun.platonic.pulsar.persist.rdb.model.dao;
...
public class OrmliteTableCreator {

    private ConnectionSource connectionSource;
    private List<Dao<?, ?>> configuredDaos;

    public OrmliteTableCreator(ConnectionSource connectionSource, OrmliteDaoFactory daoFactory) {
        this(connectionSource, daoFactory.getCreatedDaos());
    }

    public OrmliteTableCreator(ConnectionSource connectionSource, List<Dao<?, ?>> configuredDaos) {
