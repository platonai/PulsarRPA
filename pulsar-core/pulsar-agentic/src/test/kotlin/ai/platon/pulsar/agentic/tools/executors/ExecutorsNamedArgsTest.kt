...
class ExecutorsNamedArgsTest {
    ...
    fun fs_readString_uses_named_args() {
        ...
        val tc = ToolCall(domain = "fs", method = "readString", arguments = mutableMapOf<String, String?>("filename" to "a.txt", "external" to "true"))
    ...
    fun browser_switchTab_with_tabId_string() {
        ...
        val tc = ToolCall(domain = "browser", method = "switchTab", arguments = mutableMapOf<String, String?>("tabId" to "abc"))
    ...
    fun driver_click_uses_named_args() {
        ...
        val tc = ToolCall(domain = "driver", method = "click", arguments = mutableMapOf<String, String?>("selector" to "#ok", "count" to "2"))
