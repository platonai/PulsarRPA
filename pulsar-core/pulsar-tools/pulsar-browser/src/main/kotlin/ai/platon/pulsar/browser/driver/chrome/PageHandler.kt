...
class PageHandler(
    ...
    @Throws(ChromeDriverException::class)
    suspend fun getAttribute(nodeId: Int, attrName: String): String? {
    ...
    @Throws(ChromeDriverException::class)
    suspend fun scrollIntoViewIfNeeded(nodeId: Int, selector: String? = null, rect: Rect? = null): Int? {
        try {
...
//        return evaluate(iife, returnByValue = true)
    ...
    @Throws(ChromeDriverException::class)
    private suspend fun querySelectorOrNull(selector: String): Int? {
