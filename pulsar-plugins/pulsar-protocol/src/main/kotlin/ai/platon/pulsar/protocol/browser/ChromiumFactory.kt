...
class ChromiumFactory: BrowserFactory {
     ...
     * */
    override fun connect(port: Int, settings: BrowserSettings): Browser = factory.connect(port, settings)

    /**
     * Launch the system default browser, the system default browser is your daily used browser.
     * */
    @Throws(BrowserLaunchException::class)
    override fun launchSystemDefaultBrowser(): Browser = factory.launch(BrowserId.SYSTEM_DEFAULT, LauncherOptions(), ChromeOptions())

    /**
     * Launch the default browser, notice, the default browser is not the one you used daily.
     * */
    @Throws(BrowserLaunchException::class)
    override fun launchDefaultBrowser(): Browser = factory.launch(BrowserId.DEFAULT, LauncherOptions(), ChromeOptions())

    /**
     * Launch the prototype browser, the prototype browser is a browser instance with default settings.
     * */
    @Throws(BrowserLaunchException::class)
    override fun launchPrototypeBrowser(): Browser = factory.launch(BrowserId.PROTOTYPE, LauncherOptions(), ChromeOptions())
     ...
     * */
    @Throws(BrowserLaunchException::class)
    override fun launchRandomTempBrowser(): Browser = factory.launch(BrowserId.RANDOM, LauncherOptions(), ChromeOptions())
