 ...
 */
class RobustBrowserEmulatorHandlers(
        driverPool: LoadingWebDriverPool,
        messageWriter: MessageWriter,
        immutableConfig: ImmutableConfig
): BrowserEmulatorHandlers(driverPool, messageWriter, immutableConfig) {
    companion object {
        private const val SMALL_CONTENT_LIMIT = 1_000_000 / 2 // 500KiB
    }

    private val log = LoggerFactory.getLogger(RobustBrowserEmulatorHandlers::class.java)!!
