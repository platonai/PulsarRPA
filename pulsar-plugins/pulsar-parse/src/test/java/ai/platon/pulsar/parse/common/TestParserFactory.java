...
public class TestParserFactory {
    ...
    public void testGetParsers() throws Exception {
        ...
        assertEquals("ai.platon.pulsar.parse.html.HtmlParser", parsers.get(0).getClass().getName());
        ...
        assertNotNull(parsers);
        assertEquals(1, parsers.size());
        assertEquals("ai.platon.pulsar.parse.js.JSParseFilter", parsers.get(0).getClass().getName());

        parsers = parserFactory.getParsers("text/plain", "http://foo.com");
        assertNotNull(parsers);
        assertEquals(1, parsers.size());
        assertEquals("ai.platon.pulsar.parse.tika.TikaParser", parsers.get(0).getClass().getName());
