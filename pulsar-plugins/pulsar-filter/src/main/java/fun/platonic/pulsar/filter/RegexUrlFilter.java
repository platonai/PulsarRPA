...
import fun.platonic.pulsar.filter.common.RegexRule;
import fun.platonic.pulsar.filter.common.RegexUrlFilterBase;
...
public class RegexUrlFilter extends RegexUrlFilterBase {
    ...
    private class RegexRuleImpl extends RegexRule {
        ...
        protected boolean match(String url) {
            if (url == null) {
                UrlFilter.LOG.error("Null url passed into to RegexRuleFilter");
                return false;
            }
