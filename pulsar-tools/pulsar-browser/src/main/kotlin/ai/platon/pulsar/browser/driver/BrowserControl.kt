...
open class BrowserControl(
    ...
    companion object {
        ...
        val numInstances = Files.list(AppPaths.BROWSER_TMP_DIR).filter { Files.isDirectory(it) }.count()
        val autoGeneratedUserDataDir = AppPaths.BROWSER_TMP_DIR.resolve(numInstances.inc().toString())
    }
    ...
    var userDataDir = conf.getPath(CapabilityTypes.BROWSER_DATA_DIR, autoGeneratedUserDataDir)
