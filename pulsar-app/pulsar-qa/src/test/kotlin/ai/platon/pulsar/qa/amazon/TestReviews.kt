...
class TestReviews : QABase() {
    ...
    fun `When extract then is_vine_voice exists`() {
        ...
        assertAnyRecordsNotBlank(AssertEntry(url, sqlResource, listOf("IS_VINE_VOICE")))
    }
    ...
    fun `When extract then is_top_contributor exists`() {
        ...
        assertAnyRecordsNotBlank(AssertEntry(url, sqlResource, listOf("is_top_contributor")))
    }
}
