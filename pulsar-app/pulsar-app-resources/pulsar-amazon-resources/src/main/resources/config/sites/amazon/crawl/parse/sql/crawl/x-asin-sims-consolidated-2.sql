...
select dom_base_uri(dom)                                                                          as url,
       ...
       dom_first_own_text(dom_owner_body(dom),
                          '#sims-consolidated-2_feature_div h2.a-carousel-heading, ' ||
                          'div[cel_widget_id~=sims-consolidated-2] h2.a-carousel-heading'
         )                                                                                        as carousel_title,
       dom_first_text(dom_owner_body(dom),
                      '#sims-consolidated-2_feature_div h2.a-carousel-heading div.sp_desktop_sponsored_label, ' ||
                      'div[cel_widget_id~=sims-consolidated-2] h2.a-carousel-heading div.sp_desktop_sponsored_label'
         )                                                                                        as is_sponsored,
...
from load_and_select(@url,
                     '#sims-consolidated-2_feature_div ol.a-carousel li, ' ||
                     'div[cel_widget_id~=sims-consolidated-2] ol.a-carousel li'
  );
