...
public class InterceptFRFRProxyServer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ProxyConfig proxyConfig = new ProxyConfig(ProxyType.HTTP, "114.235.207.98", 4243);
    config.setHandleSsl(true);
    new HttpProxyServer()
        .serverConfig(config).proxyConfig(proxyConfig)
          ...
          public void init(HttpProxyInterceptPipeline pipeline) {
            ...
            pipeline.addLast(new FullResponseIntercept() {
              ...
              public boolean match(HttpRequest httpRequest, HttpResponse httpResponse, HttpProxyInterceptPipeline pipeline) {
                //在匹配到百度首页时插入js
                System.out.println("InterceptFullResponseProxyServer");
