...
import ai.platon.pulsar.gora.mongodb.query.MongoDBResult;
import ai.platon.pulsar.gora.mongodb.utils.BSONDecorator;
import ai.platon.pulsar.gora.mongodb.utils.GoraDBEncoder;
import org.apache.avro.Schema;
import org.apache.avro.Schema.Field;
import org.apache.avro.Schema.Type;
import org.apache.avro.generic.GenericArray;
import org.apache.avro.util.Utf8;
import ai.platon.pulsar.gora.mongodb.filters.MongoFilterUtil;
import ai.platon.pulsar.gora.mongodb.query.MongoDBQuery;
...
DataStoreBase<K, T> {
  ...
  public T newInstance(final DBObject obj, final String[] fields) {
    ...
    for (String f : dbFields) {
      ...
      MongoMapping.DocumentFieldType storeType = mapping.getDocumentFieldType(docf);
  ...
  private Object fromDBObject(final Schema fieldSchema,
                              final MongoMapping.DocumentFieldType storeType, final Field field, final String docf,
  ...
  private Object fromMongoRecord(final Schema fieldSchema, final String docf,
    ...
    for (Field recField : fieldSchema.getFields()) {
      ...
      MongoMapping.DocumentFieldType innerStoreType = mapping
  ...
  private Object fromMongoString(final MongoMapping.DocumentFieldType storeType,
  ...
  private Object toDBObject(final String docf, final Schema fieldSchema,
      final Type fieldType, final MongoMapping.DocumentFieldType storeType,
      final Object value) {
    Object result = null;
    switch (fieldType) {
    case MAP:
  ...
  private Object unionToMongo(final String docf, final Schema fieldSchema,
                              final MongoMapping.DocumentFieldType storeType, final Object value) {
    Object result;// schema [type0, type1]
    Type type0 = fieldSchema.getTypes().get(0).getType();
    Type type1 = fieldSchema.getTypes().get(1).getType();
  ...
  private BasicDBObject recordToMongo(final String docf,
    ...
    for (Field member : fieldSchema.getFields()) {
      ...
      MongoMapping.DocumentFieldType innerStoreType = mapping.getDocumentFieldType(innerDoc);
      LOG.debug(
