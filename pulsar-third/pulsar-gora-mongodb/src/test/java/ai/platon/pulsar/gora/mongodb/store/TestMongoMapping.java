...
public class TestMongoMapping {
  ...
  public void addSeveralTopLevelDocumentFields() {
    ...
    mapping.addClassField("classBin1", "topLevel1",
        MongoMapping.DocumentFieldType.BINARY.toString().toLowerCase(Locale.getDefault()));
    mapping.addClassField("classBin2", "topLevel2",
        MongoMapping.DocumentFieldType.BINARY.toString().toUpperCase(Locale.getDefault()));
    ...
    mapping.addClassField("classInt321", "topLevel3",
        MongoMapping.DocumentFieldType.INT32.toString().toLowerCase(Locale.getDefault()));
    mapping.addClassField("classInt322", "topLevel4",
        MongoMapping.DocumentFieldType.INT32.toString().toUpperCase(Locale.getDefault()));
    ...
    mapping.addClassField("classInt641", "topLevel5",
        MongoMapping.DocumentFieldType.INT64.toString().toLowerCase(Locale.getDefault()));
    mapping.addClassField("classInt642", "topLevel6",
        MongoMapping.DocumentFieldType.INT64.toString().toUpperCase(Locale.getDefault()));
    ...
    mapping.addClassField("classDouble1", "topLevel7",
        MongoMapping.DocumentFieldType.DOUBLE.toString().toLowerCase(Locale.getDefault()));
    mapping.addClassField("classDouble2", "topLevel8",
        MongoMapping.DocumentFieldType.DOUBLE.toString().toUpperCase(Locale.getDefault()));
    ...
    mapping.addClassField("classString1", "topLevel9",
        MongoMapping.DocumentFieldType.STRING.toString().toLowerCase(Locale.getDefault()));
    mapping.addClassField("classString2", "topLevel10",
        MongoMapping.DocumentFieldType.STRING.toString().toUpperCase(Locale.getDefault()));
    ...
    mapping.addClassField("classDate1", "topLevel11",
        MongoMapping.DocumentFieldType.DATE.toString().toLowerCase(Locale.getDefault()));
    mapping.addClassField("classDate2", "topLevel12",
        MongoMapping.DocumentFieldType.DATE.toString().toUpperCase(Locale.getDefault()));
    ...
    mapping.addClassField("classList1", "topLevel13",
        MongoMapping.DocumentFieldType.LIST.toString().toLowerCase(Locale.getDefault()));
    mapping.addClassField("classList2", "topLevel14",
        MongoMapping.DocumentFieldType.LIST.toString().toUpperCase(Locale.getDefault()));
    ...
    mapping.addClassField("classDocument1", "topLevel15",
        MongoMapping.DocumentFieldType.DOCUMENT.toString().toLowerCase(Locale.getDefault()));
    mapping.addClassField("classDocument2", "topLevel16",
        MongoMapping.DocumentFieldType.DOCUMENT.toString().toUpperCase(Locale.getDefault()));
  ...
  public void addSeveralDocumentFields() {
    ...
    Assert.assertEquals(MongoMapping.DocumentFieldType.DATE,
    ...
    Assert.assertEquals(MongoMapping.DocumentFieldType.LIST,
