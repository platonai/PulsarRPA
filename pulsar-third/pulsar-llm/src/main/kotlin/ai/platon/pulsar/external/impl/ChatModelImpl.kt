...
open class ChatModelImpl(
     ...
     */
    override fun call(prompt: String): ModelResponse {
        return call("", prompt)
    }
     ...
     * @return The response generated by the model.
     */
    override fun call(document: FeaturedDocument, prompt: String): ModelResponse {
     ...
     * @return The response generated by the model.
     */
    override fun call(ele: Element, prompt: String): ModelResponse {
        val text = ele.text()
