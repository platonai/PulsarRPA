...
import fun.platonic.pulsar.boilerpipe.filters.heuristics.*;
import fun.platonic.pulsar.boilerpipe.filters.simple.BoilerplateBlockFilter;
import fun.platonic.pulsar.boilerpipe.filters.simple.LabeledFieldExtractorFilter;
import fun.platonic.pulsar.boilerpipe.filters.simple.RegexFieldExtractorFilter;
import fun.platonic.pulsar.boilerpipe.filters.statistics.NumWordsRulesClassifier;
