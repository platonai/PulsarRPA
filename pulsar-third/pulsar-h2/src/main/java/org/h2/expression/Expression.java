...
public abstract class Expression {
    ...
    private int selectItemSequence;

    private boolean addedToFilter;

    public int getSelectItemSequence() {
        return selectItemSequence;
    }

    public void setSelectItemSequence(int selectItemSequence) {
        this.selectItemSequence = selectItemSequence;
    }
