 ...
 */
public class TableFilter implements ColumnResolver, Comparable<TableFilter> {
    ...
    // the order appears in the "from" clause.
     ...
     */
    public void prepare() {
        // System.out.println("==TableFilter.prepare==");
     ...
     */
    public boolean next() {
        // System.out.println("==TableFilter.next==");
...
//        System.out.println("--TableFilter::getValue--");
//        if (isExternal()) {
//            return ValueStringFixed.get("test " + column.getName());
//        }
    ...
    public Expression optimize(ExpressionColumn expressionColumn, Column column) {
        // System.out.println("--TableFilter::optimize--");
        // TODO: find out the real column name to support sequence column alias?
    ...
    @Override
    public int compareTo(TableFilter other) {
        return orderInFrom - other.orderInFrom;
    }
