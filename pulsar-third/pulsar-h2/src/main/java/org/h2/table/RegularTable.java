...
public class RegularTable extends TableBase {
     ...
     * There are four kind of persistent indexes:
     * <ul>
     * <li>PageDelegateIndex</li>
     * <li>SpatialTreeIndex</li>
     * <li>PageBtreeIndex</li>
     * <li>MultiVersionIndex</li>
     * </ul>
     * And there four kind of non-persistent indexes:
     * <ul>
     * <li>HashIndex</li>
     * <li>NonUniqueHashIndex</li>
     * <li>SpatialTreeIndex</li>
     * <li>TreeIndex</li>
     * </ul>
     * */
    ...
    )
    {
        ...
        if (!isSessionTemporary) {
            // other session may also adding the index
        ...
        if (isPersistIndexes() && indexType.isPersistent()) {
            ...
            // There are four kind of persistence indexes:
            // PageDelegateIndex, SpatialTreeIndex, and PageBtreeIndex and MultiVersionIndex
            int mainIndexColumn;
            ...
            // the index is non-persistent
            // There four kind of non-persistent indexes: HashIndex, NonUniqueHashIndex, SpatialTreeIndex and TreeIndex
            if (indexType.isHash()) {
                if (cols.length != 1) {
                ...
                index = new SpatialTreeIndex(this,
                  indexId, indexName, cols, indexType, false, true, session);
            } else {
        ...
        if (index.needRebuild() && rowCount > 0) {
            rebuildIndex(session, indexName, index);
        }
    ...
    private void rebuildIndex(Session session, String indexName, Index index) {
        try {
    ...
    private int getMainIndexColumn(IndexType indexType, IndexColumn[] cols) {
        ...
        // TODO: does the column id equal to the index of the array?
    ...
    public Session getLockExclusiveSession() {
