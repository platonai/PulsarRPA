    ...
    public Value convertTo(int targetType, int precision, Mode mode, Column column) {
        ...
        try {
            ...
            case DATE: {
                ...
                case TIMESTAMP_TZ:
                    return ValueDate.fromDateValue(((ValueTimestampTimeZone) this).getDateValue());
                case ENUM:
                    throw DbException.get(ErrorCode.DATA_CONVERSION_ERROR_1, getString());
                }
                break;
            ...
            case TIME: {
                ...
                case TIMESTAMP_TZ:
                    return ValueTime.fromNanos(((ValueTimestampTimeZone) this).getTimeNanos());
                case ENUM:
                    throw DbException.get(ErrorCode.DATA_CONVERSION_ERROR_1, getString());
                }
                break;
            ...
            case TIMESTAMP: {
                ...
                case TIMESTAMP_TZ:
                    return ValueTimestamp.fromDateValueAndNanos(((ValueTimestampTimeZone) this).getDateValue(),
