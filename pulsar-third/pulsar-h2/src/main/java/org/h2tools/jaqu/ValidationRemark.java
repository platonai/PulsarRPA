...
import org.h2tools.jaqu.TableInspector.ColumnInspector;
...
public class ValidationRemark {
    ...
    private ValidationRemark(Level level, String table, TableDefinition.FieldDefinition field,
            String message) {
        this.level = level;
        this.table = table;
    ...
    public static ValidationRemark error(String table, TableDefinition.FieldDefinition field,
            String message) {
