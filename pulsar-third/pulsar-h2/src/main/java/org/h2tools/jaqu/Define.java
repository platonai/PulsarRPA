...
public class Define {
    ...
    public static void index(Object... columns) {
        checkInDefine();
        currentTableDefinition.addIndex(Table.IndexType.STANDARD, columns);
    }

    public static void uniqueIndex(Object... columns) {
        checkInDefine();
        currentTableDefinition.addIndex(Table.IndexType.UNIQUE, columns);
    }

    public static void hashIndex(Object column) {
        checkInDefine();
        currentTableDefinition
                .addIndex(Table.IndexType.HASH, new Object[] { column });
    }

    public static void uniqueHashIndex(Object column) {
        checkInDefine();
        currentTableDefinition.addIndex(Table.IndexType.UNIQUE_HASH,
                new Object[] { column });
    }
