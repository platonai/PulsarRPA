...
public class StringBuilder {
    ...
    public StringBuilder(String s) {
        ...
        buffer = new char[len];
        org.h2tools.java.lang.System.arraycopy(chars, 0, buffer, 0, len);
        this.length = len;
    }
    ...
    public StringBuilder append(String x) {
        int l = x.length();
        ensureCapacity(l);
        org.h2tools.java.lang.System.arraycopy(x.chars, 0, buffer, length, l);
        length += l;
        return this;
    }
    ...
    private void ensureCapacity(int plus) {
        if (buffer.length < length + plus) {
            ...
            org.h2tools.java.lang.System.arraycopy(buffer, 0, b, 0, length);
            buffer = b;
        }
    }
