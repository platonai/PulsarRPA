...
class In2OutGraphUpdateJob : WebGraphUpdateJob() {
    public override fun initJob() {
        ...
        PulsarJob.initMapper(currentJob, fields, GraphGroupKey::class.java, WebGraphWritable::class.java,
                In2OutGraphUpdateMapper::class.java, getBatchIdFilter(options.batchId))
...
fun main(args: Array<String>) {
    JobEnv.initialize()
    val res = AppContextAwareJob.run(In2OutGraphUpdateJob(), args)
    exitProcess(res)
}
