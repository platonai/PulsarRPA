...
public class OutGraphUpdateJob extends WebGraphUpdateJob {
  ...
  public void initJob() throws Exception {
    ...
    initMapper(currentJob, fields, GraphGroupKey.class, WebGraphWritable.class, OutGraphUpdateMapper.class, getBatchIdFilter(batchId));
  ...
  public static void main(String[] args) throws Exception {
    ...
    int res = run(configLocation, new OutGraphUpdateJob(), args);
    System.exit(res);
  }
}
