...
[PulsarRPAPro](https://github.com/platonai/PulsarRPAPro) ，[国内镜像](https://gitee.com/platonai_galaxyeye/PulsarRPAPro)，代表奇异星（Exotic Star），是 Browser4 的专业版和控制台，它包含：

- 一个**命令行工具**，可以从命令行直接执行网页数据采集任务，而不需要打开 IDE 写代码
- 一个 **Web 控制台**，方便我们管理 Browser4 服务，并编写 SQL 来访问 Web，提取数据
- 一个升级版的 Browser4 服务器，我们可以在客户端编写 SQL 来访问 Web，提取数据
