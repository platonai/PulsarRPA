...
[source,kotlin]
----
implementation("ai.platon.pulsar:pulsar-all:1.10.6")
----
...
HUAWEI P20 Lite (32GB + 4GB RAM) 5.84" FHD+ Display ... | Visit the HUAWEI Store | $1.10.6 | 1,349 ratings | 4.40
----
...
. link:pulsar-app/pulsar-examples/src/main/kotlin/ai/platon/pulsar/examples/_4_Flow.kt[Flow]
