...
* PulsarR 服务器，我们可以向服务器发送 SQL 来采集 Web 数据
...
[source,kotlin]
----
implementation("ai.platon.pulsar:pulsar-all:1.10.4")
----
...
HUAWEI P20 Lite (32GB + 4GB RAM) 5.84" FHD+ Display ... | Visit the HUAWEI Store | $1.10.4 | 1,349 ratings | 4.40
----
