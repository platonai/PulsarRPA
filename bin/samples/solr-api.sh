...
# Clear the index
curl http://platonic.fun:8983/solr/information_tmp/update?commitWithin=3000 -d '{delete:{query:"*:*"}}'
curl http://platonic.fun:8983/solr/information_tmp/update?commitWithin=3000 -d '{delete:{query:"*:*"}}'

## General query
curl http://platonic.fun:8983/solr/information_1101_integration_test/query -d 'q=*:*&fl=id'

## 条件查询
curl http://platonic.fun:8983/solr/information_1101_integration_test/query -d '
...
#### 曝光量统计 ####
# 今天抓取
curl http://platonic.fun:8983/solr/information_1101_integration_test/query -d 'q=last_crawl_time:[NOW/DAY TO *]&fl=url'
# 今天抓取，按domain分组
curl http://platonic.fun:8983/solr/information_1101_integration_test/query -d '
...
# 过去24小时抓取
curl http://platonic.fun:8983/solr/information_1101_integration_test/query -d 'q=last_crawl_time:[NOW-1DAY/DAY TO *]&fl=url'
...
#### 热点话题 ####
curl http://platonic.fun:8983/solr/information_1101_integration_test/select -d '
q=*:*&
...
curl http://platonic.fun:8983/solr/information_1101_integration_test/select -d 'qt=tvrh&q=text:[* TO *]&fl=article_title&indent=on'
...
curl http://platonic.fun:8983/solr/information_1101_integration_test/update?commitWithin=3000 -d "<delete><query>publish_time:[NOW+1DAY TO *] OR publish_time:[* TO NOW-30DAYS]</query></delete>"
curl http://platonic.fun:8983/solr/information_1101_integration_test/update?commitWithin=3000 -d "<delete><query>last_crawl_time:[NOW+1DAY TO *] OR last_crawl_time:[* TO NOW-30DAYS]</query></delete>"
