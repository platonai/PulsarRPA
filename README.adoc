...
PulsarR [ˈpʌlsɑr] stands for Pulsar Radiation. If there is no confusion with other projects, it can be referred to as Pulsar.
...
* RPA: robotic process automation, mimic human behaviors, SPA crawling, or do something else awesome
...
* Browser Rendering: fetch webpages using real browsers
