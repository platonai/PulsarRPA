...
Typical logs for task status are shown below, check link:docs/log-format.adoc[log-format] to learn how to read the logs to learn the status of the whole system at a glance.
