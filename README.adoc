...
The code above scrapes fields specified by css selector #title and #acrCustomerReviewText from a set of product pages. The example code can be found here: link:pulsar-app/pulsar-examples/src/main/kotlin/ai/platon/pulsar/examples/sites/topEc/english/amazon/AmazonCrawler.kt[kotlin].
...
[source,kotlin]
----
implementation("ai.platon.pulsar:pulsar-all:1.9.8")
----
...
HUAWEI P20 Lite (32GB + 4GB RAM) 5.84" FHD+ Display ... | Visit the HUAWEI Store | $1.9.8 | 1,349 ratings | 4.40
----
