...
== Core concepts
The core Pulsar concepts includes: Web Scraping, Network As A Database, Auto Extract, Browser Rendering, Pulsar Session, Urls, Hyperlinks, Load Options, Event Handler and X-SQL.
