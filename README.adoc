...
Pulsar provides a convenient way to mimic real people during the lifecycle of a webpage, using web drivers to interact with the webpage: scrolling, typing, screen capturing, mouse dropping, clicking and more.
