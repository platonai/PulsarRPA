...
* [Coming Soon] Information Extraction: Automatically learns web data patterns and automatically extracts every field in a webpage with remarkable precision
