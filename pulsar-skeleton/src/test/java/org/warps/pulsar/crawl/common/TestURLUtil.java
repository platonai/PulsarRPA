...
import org.warps.pulsar.net.domain.DomainSuffixes;
...
public class TestURLUtil {
    ...
    public void testGetDomainName() throws Exception {
        ...
        url = new URL("http://pulsar.apache.org");
    ...
    public void testGetDomainSuffix() throws Exception {
        ...
        url = new URL("http://lucene.apache.org/pulsar");
    ...
    public void testFileProtocol() throws Exception {
        // keep one single slash PULSAR-XXX
