...
import static fun.platonic.pulsar.common.config.CapabilityTypes.GLOBAL_EXECUTOR_AUTO_CONCURRENCY_FACTOR;
import static fun.platonic.pulsar.common.config.CapabilityTypes.GLOBAL_EXECUTOR_CONCURRENCY_HINT;
