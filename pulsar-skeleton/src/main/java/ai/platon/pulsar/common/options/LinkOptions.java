...
public class LinkOptions extends PulsarOptions {
    ...
    private void init(ImmutableConfig conf) {
        this.minAnchorLength = conf.getUint(CapabilityTypes.PARSE_MIN_ANCHOR_LENGTH, 8);
        this.maxAnchorLength = conf.getUint(CapabilityTypes.PARSE_MAX_ANCHOR_LENGTH, 40);
    }
