...
import org.warps.pulsar.crawl.signature.Signature;
import org.warps.pulsar.crawl.signature.TextMD5Signature;
...
import static org.warps.pulsar.common.config.CapabilityTypes.PARSE_MAX_LINKS_PER_PAGE;
import static org.warps.pulsar.common.config.CapabilityTypes.PARSE_TIMEOUT;
import static org.warps.pulsar.persist.metadata.Name.NO_FOLLOW;
import static org.warps.pulsar.persist.metadata.Name.REDIRECT_DISCOVERED;
import static org.warps.pulsar.persist.metadata.ParseStatusCodes.FAILED;
