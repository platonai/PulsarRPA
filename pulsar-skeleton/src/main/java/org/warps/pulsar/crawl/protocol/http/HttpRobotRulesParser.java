...
import org.warps.pulsar.crawl.protocol.RobotRulesParser;
...
public class HttpRobotRulesParser extends RobotRulesParser {
    ...
    public HttpRobotRulesParser(ImmutableConfig conf) {
        super(conf);
            ...
            try {
                ...
                if (response.getCode() == 301 || response.getCode() == 302) {
                    ...
                    if (redirection != null) {
                        ...
                        response = ((AbstractHttpProtocol) http).getResponse(redir.toString(), WebPage.newWebPage(url.toString()), true);
                    }
                }
