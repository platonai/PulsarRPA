...
import org.warps.pulsar.crawl.filter.CrawlFilter;
...
import org.warps.pulsar.crawl.signature.SignatureComparator;
import org.warps.pulsar.persist.CrawlStatus;
import org.warps.pulsar.persist.PageCounters;
...
import static org.warps.pulsar.common.config.CapabilityTypes.FETCH_MAX_INTERVAL;
import static org.warps.pulsar.common.config.CapabilityTypes.FETCH_MAX_RETRY;
