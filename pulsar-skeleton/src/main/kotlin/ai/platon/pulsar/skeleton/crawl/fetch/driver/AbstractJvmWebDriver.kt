...
abstract class AbstractJvmWebDriver: JvmWebDriver, WebDriver {
    ...
    override fun addProbabilityBlockedURLsAsync(urlPatterns: List<String>) = interopScope.future { addProbabilityBlockedURLs(urlPatterns) }
    ...
    override fun waitUntilAsync(timeoutMillis: Long, predicate: () -> Boolean) = interopScope.future { waitUntil(timeoutMillis, predicate) }
    override fun waitUntilAsync(timeout: Duration, predicate: () -> Boolean) = interopScope.future { waitUntil(timeout, predicate) }
    ...
    override fun clickTextMatchesAsync(selector: String, pattern: String, count: Int) = interopScope.future { clickTextMatches(selector, pattern, count) }
    ...
    override fun moveMouseToAsync(selector: String, deltaX: Int, deltaY: Int) = interopScope.future { moveMouseTo(selector, deltaX, deltaY) }
    ...
    override fun selectPropertyValueAllAsync(selector: String, propName: String, start: Int, limit: Int): CompletableFuture<List<String>> =
