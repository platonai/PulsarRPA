        ...
        try {
            ...
            if (fieldList.length > 0) {
                for (i in 0 until fieldList.length) {
                    ...
                    val bIndexed = indexed != null && indexed.equals("true", ignoreCase = true)
                    val bStored = stored != null && stored.equals("true", ignoreCase = true)
                    val bRequired = required != null && required.equals("true", ignoreCase = true)
                    val bMultiValued = multiValued != null && multiValued.equals("true", ignoreCase = true)
